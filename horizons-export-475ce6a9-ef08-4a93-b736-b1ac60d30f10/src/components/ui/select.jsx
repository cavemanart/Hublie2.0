...
const SelectTrigger = React.forwardRef(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      'hover:border-primary/70 transition-colors duration-200 ease-in-out shadow-sm hover:shadow-md',
      className
    )}
    {...props}
  >
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        'border-primary/30 bg-gradient-to-br from-popover to-background/90',
        position === 'popper' &&
...
const SelectSeparator = React.forwardRef(({ className, ...props }, ref) => (
  <SelectPrimitive.Separator
    ref={ref}
    className={cn('-mx-1 my-1 h-px bg-muted bg-border/50', className)}
    {...props}
  />
));
